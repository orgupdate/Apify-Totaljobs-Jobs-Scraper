# Apify - TotalJobs Jobs Scraper

## Overview

The **TotalJobs Jobs Scraper** is a powerful tool designed to scrape and aggregate job listings from multiple sources. Whether you're building a job portal, conducting market research, or tracking employment trends, this actor provides structured job data in real time.
...
| `datePosted`          | String | Value can be "all", "24h", "48h", "72h", "3days", "7days", "14days". Default: "all". |
...
2. Search for **TotalJobs Jobs Scraper**.  
